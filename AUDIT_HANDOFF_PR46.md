...
📄 **Full prioritised scope with clickable file links → [scope.md](./scope.md)**

| Priority | Group | Files |
|----------|-------|-------|
| 🔴 P1 | Core custody/accounting | `V3Vault.sol`, `V3Oracle.sol`, `InterestRateModel.sol` |
| 🟠 P2 | Staking / gauge integration | `GaugeManager.sol`, `IGaugeManager.sol`, `interfaces/aerodrome/*` |
| 🟡 P3 | Flash + swap boundary | `FlashloanLiquidator.sol`, `Swapper.sol` |
| 🟢 P4 | Automation / transforms | `Automator.sol`, `AutoExit.sol`, `AutoRangeAndCompound.sol`, `Transformer.sol`, `V3Utils.sol` |
